...
namespace StateByState
{
    ...
    public class SecondViewModel : NotifyBase
    {
        ...
        public SecondViewModel()
        {
            ...
            StateManager2.DefineState(SecondStates2.StateX);
            StateManager2.DefineState(SecondStates2.StateY);
            StateManager2.DefineState(SecondStates2.StateZ);
            //{
        ...
        public void ToFirst()
        {
            StateManager.Transition(SecondStates.State2);// SecondStateTransitions.State1To2);
        ...
        {
            StateManager.Transition(SecondStates.State2);// SecondStateTransitions.State2To3);
        ...
        public void ToThird()
        {
            StateManager.Transition(SecondStates.State3);// SecondStateTransitions.State3To1);
        ...
        {
            await StateManager2.Transition(SecondStates2.StateZ);// SecondStateTransitions.StateXToZ);
        }
        public async Task YtoZ()
        {
            await StateManager2.Transition(SecondStates2.StateZ);// SecondStateTransitions.StateYToZ);
        }
        public async Task ZtoY()
        {
            await StateManager2.Transition(SecondStates2.StateY);// SecondStateTransitions.StateZToY);
        }
        public async Task YtoX()
        {
            await StateManager2.Transition(SecondStates2.StateX);// SecondStateTransitions.StateYToX);
        }
